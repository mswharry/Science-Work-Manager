...
- kế hoạch hoạt động khoa học theo năm học,
- phân cấp đề tài và phân cấp bài báo,
- mẫu biểu đăng ký/khai báo có thể mở rộng,
- theo dõi tiến độ đề tài sau khi được duyệt.
...
### Lecturer
- Đăng ký đề tài
- Gửi yêu cầu nghiệm thu đề tài đã được duyệt
...
### Student
- Đăng ký tài khoản
- Khai báo bài báo (bắt buộc có giảng viên hướng dẫn hợp lệ)
- Xem đề tài, bài báo, thông báo theo quyền
- Xem hồ sơ cá nhân

## Phạm vi chức năng (Implemented Baseline)
Dự án hiện đã triển khai 6 nhóm chức năng:
1. Authentication
...
## Phạm vi Planned Expansion
Các nhóm mở rộng planned:
1. Kế hoạch năm học
2. Quản lý mẫu biểu (template)
3. Theo dõi tiến độ đề tài (task/report/progress)
4. Phân cấp đề tài/bài báo
...
## Mở rộng theo yêu cầu giảng viên (đợt 2026)
Các yêu cầu mở rộng (kế hoạch năm học, phân cấp, form mẫu, tiến độ đề tài, cảnh báo quá hạn)
được định nghĩa chính thức tại:

- FEATURE_EXPANSION_2026.md

Khi chạy phase mở rộng, đây là file bắt buộc phải đọc cùng với bộ spec nền.