const EXACT_MESSAGE_MAP = {
  ...
  "Only lecturers can create projects.": "Chỉ giảng viên mới được phép tạo đề tài.",
  ...
  "Only project leader can request project completion.": "Chỉ chủ nhiệm đề tài mới có thể gửi yêu cầu hoàn thành.",
  "Only approved projects can request completion confirmation.": "Chỉ đề tài đã được phê duyệt mới có thể gửi yêu cầu hoàn thành.",
  "Completion confirmation has already been requested for this project.": "Đề tài này đã được gửi yêu cầu xác nhận hoàn thành trước đó.",
  "Only approved projects with completion request can be completed.": "Chỉ đề tài đã được duyệt và đã gửi yêu cầu hoàn thành mới có thể được xác nhận hoàn thành.",
  "Only admin can manage registration periods.": "Chỉ quản trị viên mới được quản lý đợt đăng ký.",
  "Registration period not found.": "Không tìm thấy đợt đăng ký.",
  "registration_start must be before or equal to registration_end.": "Ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc.",
  "Cannot delete this registration period because it is being used by projects.": "Không thể xóa đợt đăng ký vì đang có hồ sơ đề tài sử dụng.",
  "Title is required.": "Vui lòng nhập tên đợt đăng ký.",
  ...
  "Admins are not allowed to create papers.": "Quản trị viên không được phép tạo bài báo.",
  "Student paper requires a supervising lecturer.": "Sinh viên khai báo bài báo bắt buộc phải chọn giảng viên hướng dẫn.",
  "Supervisor lecturer not found.": "Không tìm thấy giảng viên hướng dẫn được chọn.",
