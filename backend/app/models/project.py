...
class Project(Base, TimestampMixin):
    ...
    registration_period_id: Mapped[Optional[int]] = mapped_column(ForeignKey("registration_periods.id"), nullable=True, index=True)
    ...
    registration_period = relationship("RegistrationPeriod", back_populates="projects")
