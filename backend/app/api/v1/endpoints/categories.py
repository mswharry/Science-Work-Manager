...
def create_project_type(
    ...
    category = create_category(db=db, payload=payload, category_type=CategoryType.PROJECT_TYPE.value)
...
def update_project_type(
    ...
    category = update_category(
        ...
        payload=payload,
        category_type=CategoryType.PROJECT_TYPE.value,
    )
    return CategoryOut.model_validate(category)
...
def delete_project_type(
    ...
    delete_category(db=db, category_id=category_id, category_type=CategoryType.PROJECT_TYPE.value)
...
def create_paper_type(
    ...
    category = create_category(db=db, payload=payload, category_type=CategoryType.PAPER_TYPE.value)
    return CategoryOut.model_validate(category)
...
def update_paper_type(
    ...
    category = update_category(
        ...
        category_id=category_id,
        payload=payload,
        category_type=CategoryType.PAPER_TYPE.value,
    )
    return CategoryOut.model_validate(category)
...
def delete_paper_type(
    ...
    delete_category(db=db, category_id=category_id, category_type=CategoryType.PAPER_TYPE.value)
    return MessageResponse(message="Category deleted successfully")
